...
def modelGenerator(scene_name):
    ...
    uri.text = "model://"+scene_name+"/materials/textures/heightmap.png"

    size = ET.SubElement(heightmap_collision,"size")
    size.text = "129 129y 12"
    ...
    diffuse.text = "model://"+scene_name+"/materials/textures/pavement_texture.jpg"
